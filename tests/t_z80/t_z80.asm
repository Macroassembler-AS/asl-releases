	...
	;res	0,(ix+12h)	; dd cb 12 80
	;res	0,(ix+12h)	; dd cb 12 81
	;res	0,(ix+12h)	; dd cb 12 82
	;res	0,(ix+12h)	; dd cb 12 83
	;res	0,(ix+12h)	; dd cb 12 84
	;res	0,(ix+12h)	; dd cb 12 85
	res	0,(ix+12h)	; dd cb 12 86
	;res	0,(ix+12h)	; dd cb 12 87
	;res	1,(ix+12h)	; dd cb 12 88
	;res	1,(ix+12h)	; dd cb 12 89
	;res	1,(ix+12h)	; dd cb 12 8a
	;res	1,(ix+12h)	; dd cb 12 8b
	;res	1,(ix+12h)	; dd cb 12 8c
	;res	1,(ix+12h)	; dd cb 12 8d
	res	1,(ix+12h)	; dd cb 12 8e
	;res	1,(ix+12h)	; dd cb 12 8f
	;res	2,(ix+12h)	; dd cb 12 90
	;res	2,(ix+12h)	; dd cb 12 91
	;res	2,(ix+12h)	; dd cb 12 92
	;res	2,(ix+12h)	; dd cb 12 93
	;res	2,(ix+12h)	; dd cb 12 94
	;res	2,(ix+12h)	; dd cb 12 95
	res	2,(ix+12h)	; dd cb 12 96
	;res	2,(ix+12h)	; dd cb 12 97
	;res	3,(ix+12h)	; dd cb 12 98
	;res	3,(ix+12h)	; dd cb 12 99
	;res	3,(ix+12h)	; dd cb 12 9a
	;res	3,(ix+12h)	; dd cb 12 9b
	;res	3,(ix+12h)	; dd cb 12 9c
	;res	3,(ix+12h)	; dd cb 12 9d
	res	3,(ix+12h)	; dd cb 12 9e
	;res	3,(ix+12h)	; dd cb 12 9f
	;res	4,(ix+12h)	; dd cb 12 a0
	;res	4,(ix+12h)	; dd cb 12 a1
	;res	4,(ix+12h)	; dd cb 12 a2
	;res	4,(ix+12h)	; dd cb 12 a3
	;res	4,(ix+12h)	; dd cb 12 a4
	;res	4,(ix+12h)	; dd cb 12 a5
	res	4,(ix+12h)	; dd cb 12 a6
	;res	4,(ix+12h)	; dd cb 12 a7
	;res	5,(ix+12h)	; dd cb 12 a8
	;res	5,(ix+12h)	; dd cb 12 a9
	;res	5,(ix+12h)	; dd cb 12 aa
	;res	5,(ix+12h)	; dd cb 12 ab
	;res	5,(ix+12h)	; dd cb 12 ac
	;res	5,(ix+12h)	; dd cb 12 ad
	res	5,(ix+12h)	; dd cb 12 ae
	;res	5,(ix+12h)	; dd cb 12 af
	;res	6,(ix+12h)	; dd cb 12 b0
	;res	6,(ix+12h)	; dd cb 12 b1
	;res	6,(ix+12h)	; dd cb 12 b2
	;res	6,(ix+12h)	; dd cb 12 b3
	;res	6,(ix+12h)	; dd cb 12 b4
	;res	6,(ix+12h)	; dd cb 12 b5
	res	6,(ix+12h)	; dd cb 12 b6
	;res	6,(ix+12h)	; dd cb 12 b7
	;res	7,(ix+12h)	; dd cb 12 b8
	;res	7,(ix+12h)	; dd cb 12 b9
	;res	7,(ix+12h)	; dd cb 12 ba
	;res	7,(ix+12h)	; dd cb 12 bb
	;res	7,(ix+12h)	; dd cb 12 bc
	;res	7,(ix+12h)	; dd cb 12 bd
	res	7,(ix+12h)	; dd cb 12 be
	;res	7,(ix+12h)	; dd cb 12 bf
	;set	0,(ix+12h)	; dd cb 12 c0
	;set	0,(ix+12h)	; dd cb 12 c1
	;set	0,(ix+12h)	; dd cb 12 c2
	;set	0,(ix+12h)	; dd cb 12 c3
	;set	0,(ix+12h)	; dd cb 12 c4
	;set	0,(ix+12h)	; dd cb 12 c5
	set	0,(ix+12h)	; dd cb 12 c6
	;set	0,(ix+12h)	; dd cb 12 c7
	;set	1,(ix+12h)	; dd cb 12 c8
	;set	1,(ix+12h)	; dd cb 12 c9
	;set	1,(ix+12h)	; dd cb 12 ca
	;set	1,(ix+12h)	; dd cb 12 cb
	;set	1,(ix+12h)	; dd cb 12 cc
	;set	1,(ix+12h)	; dd cb 12 cd
	set	1,(ix+12h)	; dd cb 12 ce
	;set	1,(ix+12h)	; dd cb 12 cf
	;set	2,(ix+12h)	; dd cb 12 d0
	;set	2,(ix+12h)	; dd cb 12 d1
	;set	2,(ix+12h)	; dd cb 12 d2
	;set	2,(ix+12h)	; dd cb 12 d3
	;set	2,(ix+12h)	; dd cb 12 d4
	;set	2,(ix+12h)	; dd cb 12 d5
	set	2,(ix+12h)	; dd cb 12 d6
	;set	2,(ix+12h)	; dd cb 12 d7
	;set	3,(ix+12h)	; dd cb 12 d8
	;set	3,(ix+12h)	; dd cb 12 d9
	;set	3,(ix+12h)	; dd cb 12 da
	;set	3,(ix+12h)	; dd cb 12 db
	;set	3,(ix+12h)	; dd cb 12 dc
	;set	3,(ix+12h)	; dd cb 12 dd
	set	3,(ix+12h)	; dd cb 12 de
	;set	3,(ix+12h)	; dd cb 12 df
	;set	4,(ix+12h)	; dd cb 12 e0
	;set	4,(ix+12h)	; dd cb 12 e1
	;set	4,(ix+12h)	; dd cb 12 e2
	;set	4,(ix+12h)	; dd cb 12 e3
	;set	4,(ix+12h)	; dd cb 12 e4
	;set	4,(ix+12h)	; dd cb 12 e5
	set	4,(ix+12h)	; dd cb 12 e6
	;set	4,(ix+12h)	; dd cb 12 e7
	;set	5,(ix+12h)	; dd cb 12 e8
	;set	5,(ix+12h)	; dd cb 12 e9
	;set	5,(ix+12h)	; dd cb 12 ea
	;set	5,(ix+12h)	; dd cb 12 eb
	;set	5,(ix+12h)	; dd cb 12 ec
	;set	5,(ix+12h)	; dd cb 12 ed
	set	5,(ix+12h)	; dd cb 12 ee
	;set	5,(ix+12h)	; dd cb 12 ef
	;set	6,(ix+12h)	; dd cb 12 f0
	;set	6,(ix+12h)	; dd cb 12 f1
	;set	6,(ix+12h)	; dd cb 12 f2
	;set	6,(ix+12h)	; dd cb 12 f3
	;set	6,(ix+12h)	; dd cb 12 f4
	;set	6,(ix+12h)	; dd cb 12 f5
	set	6,(ix+12h)	; dd cb 12 f6
	;set	6,(ix+12h)	; dd cb 12 f7
	;set	7,(ix+12h)	; dd cb 12 f8
	;set	7,(ix+12h)	; dd cb 12 f9
	;set	7,(ix+12h)	; dd cb 12 fa
	;set	7,(ix+12h)	; dd cb 12 fb
	;set	7,(ix+12h)	; dd cb 12 fc
	;set	7,(ix+12h)	; dd cb 12 fd
	set	7,(ix+12h)	; dd cb 12 fe
	;set	7,(ix+12h)	; dd cb 12 ff
	...
	;res	0,(iy+12h)	; fd cb 12 80
	;res	0,(iy+12h)	; fd cb 12 81
	;res	0,(iy+12h)	; fd cb 12 82
	;res	0,(iy+12h)	; fd cb 12 83
	;res	0,(iy+12h)	; fd cb 12 84
	;res	0,(iy+12h)	; fd cb 12 85
	res	0,(iy+12h)	; fd cb 12 86
	;res	0,(iy+12h)	; fd cb 12 87
	;res	1,(iy+12h)	; fd cb 12 88
	;res	1,(iy+12h)	; fd cb 12 89
	;res	1,(iy+12h)	; fd cb 12 8a
	;res	1,(iy+12h)	; fd cb 12 8b
	;res	1,(iy+12h)	; fd cb 12 8c
	;res	1,(iy+12h)	; fd cb 12 8d
	res	1,(iy+12h)	; fd cb 12 8e
	;res	1,(iy+12h)	; fd cb 12 8f
	;res	2,(iy+12h)	; fd cb 12 90
	;res	2,(iy+12h)	; fd cb 12 91
	;res	2,(iy+12h)	; fd cb 12 92
	;res	2,(iy+12h)	; fd cb 12 93
	;res	2,(iy+12h)	; fd cb 12 94
	;res	2,(iy+12h)	; fd cb 12 95
	res	2,(iy+12h)	; fd cb 12 96
	;res	2,(iy+12h)	; fd cb 12 97
	;res	3,(iy+12h)	; fd cb 12 98
	;res	3,(iy+12h)	; fd cb 12 99
	;res	3,(iy+12h)	; fd cb 12 9a
	;res	3,(iy+12h)	; fd cb 12 9b
	;res	3,(iy+12h)	; fd cb 12 9c
	;res	3,(iy+12h)	; fd cb 12 9d
	res	3,(iy+12h)	; fd cb 12 9e
	;res	3,(iy+12h)	; fd cb 12 9f
	;res	4,(iy+12h)	; fd cb 12 a0
	;res	4,(iy+12h)	; fd cb 12 a1
	;res	4,(iy+12h)	; fd cb 12 a2
	;res	4,(iy+12h)	; fd cb 12 a3
	;res	4,(iy+12h)	; fd cb 12 a4
	;res	4,(iy+12h)	; fd cb 12 a5
	res	4,(iy+12h)	; fd cb 12 a6
	;res	4,(iy+12h)	; fd cb 12 a7
	;res	5,(iy+12h)	; fd cb 12 a8
	;res	5,(iy+12h)	; fd cb 12 a9
	;res	5,(iy+12h)	; fd cb 12 aa
	;res	5,(iy+12h)	; fd cb 12 ab
	;res	5,(iy+12h)	; fd cb 12 ac
	;res	5,(iy+12h)	; fd cb 12 ad
	res	5,(iy+12h)	; fd cb 12 ae
	;res	5,(iy+12h)	; fd cb 12 af
	;res	6,(iy+12h)	; fd cb 12 b0
	;res	6,(iy+12h)	; fd cb 12 b1
	;res	6,(iy+12h)	; fd cb 12 b2
	;res	6,(iy+12h)	; fd cb 12 b3
	;res	6,(iy+12h)	; fd cb 12 b4
	;res	6,(iy+12h)	; fd cb 12 b5
	res	6,(iy+12h)	; fd cb 12 b6
	;res	6,(iy+12h)	; fd cb 12 b7
	;res	7,(iy+12h)	; fd cb 12 b8
	;res	7,(iy+12h)	; fd cb 12 b9
	;res	7,(iy+12h)	; fd cb 12 ba
	;res	7,(iy+12h)	; fd cb 12 bb
	;res	7,(iy+12h)	; fd cb 12 bc
	;res	7,(iy+12h)	; fd cb 12 bd
	res	7,(iy+12h)	; fd cb 12 be
	;res	7,(iy+12h)	; fd cb 12 bf
	;set	0,(iy+12h)	; fd cb 12 c0
	;set	0,(iy+12h)	; fd cb 12 c1
	;set	0,(iy+12h)	; fd cb 12 c2
	;set	0,(iy+12h)	; fd cb 12 c3
	;set	0,(iy+12h)	; fd cb 12 c4
	;set	0,(iy+12h)	; fd cb 12 c5
	set	0,(iy+12h)	; fd cb 12 c6
	;set	0,(iy+12h)	; fd cb 12 c7
	;set	1,(iy+12h)	; fd cb 12 c8
	;set	1,(iy+12h)	; fd cb 12 c9
	;set	1,(iy+12h)	; fd cb 12 ca
	;set	1,(iy+12h)	; fd cb 12 cb
	;set	1,(iy+12h)	; fd cb 12 cc
	;set	1,(iy+12h)	; fd cb 12 cd
	set	1,(iy+12h)	; fd cb 12 ce
	;set	1,(iy+12h)	; fd cb 12 cf
	;set	2,(iy+12h)	; fd cb 12 d0
	;set	2,(iy+12h)	; fd cb 12 d1
	;set	2,(iy+12h)	; fd cb 12 d2
	;set	2,(iy+12h)	; fd cb 12 d3
	;set	2,(iy+12h)	; fd cb 12 d4
	;set	2,(iy+12h)	; fd cb 12 d5
	set	2,(iy+12h)	; fd cb 12 d6
	;set	2,(iy+12h)	; fd cb 12 d7
	;set	3,(iy+12h)	; fd cb 12 d8
	;set	3,(iy+12h)	; fd cb 12 d9
	;set	3,(iy+12h)	; fd cb 12 da
	;set	3,(iy+12h)	; fd cb 12 db
	;set	3,(iy+12h)	; fd cb 12 dc
	;set	3,(iy+12h)	; fd cb 12 dd
	set	3,(iy+12h)	; fd cb 12 de
	;set	3,(iy+12h)	; fd cb 12 df
	;set	4,(iy+12h)	; fd cb 12 e0
	;set	4,(iy+12h)	; fd cb 12 e1
	;set	4,(iy+12h)	; fd cb 12 e2
	;set	4,(iy+12h)	; fd cb 12 e3
	;set	4,(iy+12h)	; fd cb 12 e4
	;set	4,(iy+12h)	; fd cb 12 e5
	set	4,(iy+12h)	; fd cb 12 e6
	;set	4,(iy+12h)	; fd cb 12 e7
	;set	5,(iy+12h)	; fd cb 12 e8
	;set	5,(iy+12h)	; fd cb 12 e9
	;set	5,(iy+12h)	; fd cb 12 ea
	;set	5,(iy+12h)	; fd cb 12 eb
	;set	5,(iy+12h)	; fd cb 12 ec
	;set	5,(iy+12h)	; fd cb 12 ed
	set	5,(iy+12h)	; fd cb 12 ee
	;set	5,(iy+12h)	; fd cb 12 ef
	;set	6,(iy+12h)	; fd cb 12 f0
	;set	6,(iy+12h)	; fd cb 12 f1
	;set	6,(iy+12h)	; fd cb 12 f2
	;set	6,(iy+12h)	; fd cb 12 f3
	;set	6,(iy+12h)	; fd cb 12 f4
	;set	6,(iy+12h)	; fd cb 12 f5
	set	6,(iy+12h)	; fd cb 12 f6
	;set	6,(iy+12h)	; fd cb 12 f7
	;set	7,(iy+12h)	; fd cb 12 f8
	;set	7,(iy+12h)	; fd cb 12 f9
	;set	7,(iy+12h)	; fd cb 12 fa
	;set	7,(iy+12h)	; fd cb 12 fb
	;set	7,(iy+12h)	; fd cb 12 fc
	;set	7,(iy+12h)	; fd cb 12 fd
	set	7,(iy+12h)	; fd cb 12 fe
	;set	7,(iy+12h)	; fd cb 12 ff
