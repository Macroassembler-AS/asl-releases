...
interpreted as a file name by AS:
\begin{verbatim}
        CHARSET  "mapping.bin"
\end{verbatim}
AS reads the first 256 bytes from this table and copies them into the translation
...
%%-----------
\begin{quote}
ai) AT90S1200, AT90S2313, AT90S2323, AT90S233,\\
...
%%-----------
\begin{quote}
ak) 80C166 $\rightarrow$ 80C167,80C165,80C163
\end{quote}
...
%%-----------
\begin{quote}
bm) 370C010, 370C020, 370C030, 370C040 and 370C050
\end{quote}
...
%%-----------
\begin{quote}
cq) 1802 $\rightarrow$ 1804, 1805, 1806 $\rightarrow$ 1804A,
1805A, 1806A
\end{quote}
...
{\em valid for: MCS-51/251, PowerPC, SC/MP, 2650}
...
{\em valid for: ST6, \tty{ASCII} also on IMP-16/IPC-16}
...
a sign extension, which turns \$ff into the desired value \$ffff.  AS is aware
...
extension.  AS will therefore by default only use the shorter encoding if 
