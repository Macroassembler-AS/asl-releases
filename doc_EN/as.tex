...
\vspace{1cm}\par
{\huge Macro Assembler \asname{} V1.42\\ (''ACASM'')}\\
\rule{9.5cm}{0.3mm}\\
\vspace{2mm}\par
{\huge User's Manual}
...
AS.MSG            & text resources for \asname{} \\
...
aswitch without the optional argument, \asname{} will try to interprete the
...
\begin{verbatim}
   ...
   move.b   #"A",d0      ; not allowed in older versions of \asname{}!
\end{verbatim}
...
\item{\tty{BYTE} resp. \tty{WORD} are available on PDP-11 and WD16 as an
      alias for \tty{DB} resp. \tty{DW}.}
...
personally involved into \asname{}, he is at least my boss and always puts
at least four eyes on what I am doing.  Regarding \asname{}, there seems to
...
I did not entirely write \asname{} on my own. The DOS version of \asname{} contained
