...
\begin{tabbing}
\hspace{0.7cm} \= \kill
ac) \> 87C750 $\rightarrow$ 8051, 8052, 80C320, 80C501, 80C502, \\
...
%%-----------
\begin{quote}
ad) 8096 $\rightarrow$ 80196 $\rightarrow$ 80196N $\rightarrow$ 80296
\end{quote}
...
%%-----------
\begin{quote}
ae) 8080 $\rightarrow$ V30EMU $\rightarrow$ 8085 $\rightarrow$ 8085UNDOC
\end{quote}
...
%%-----------
\begin{quote}
af) 8086 $\rightarrow$ 80186 $\rightarrow$ V30 $\rightarrow$ V35
\end{quote}
...
%%-----------
\begin{quote}
aj) AT90S1200, AT90S2313, AT90S2323, AT90S233,\\
...
%%-----------
\begin{quote}
ak) AM29245 $\rightarrow$ AM29243 $\rightarrow$ AM29240 $\rightarrow$ AM29000
\end{quote}
...
%%-----------
\begin{quote}
al) 80C166 $\rightarrow$ 80C167,80C165,80C163
\end{quote}
...
%%-----------
\begin{quote}
am) LR35902/GBZ80 $\rightarrow$ Z80 $\rightarrow$ Z80UNDOC \\
...
%%-----------
\begin{quote}
an) Z8601, Z8603, z86C03, z86E03, Z86C06, Z86E06, \\
...
%%-----------
\begin{quote}
aq) MICO8\_05, MICO8\_V3, MICO8\_V31
\end{quote}
...
%%-----------
\begin{quote}
av) 47C00 $\rightarrow$ 470C00 $\rightarrow$ 470AC00
\end{quote}
...
%%-----------
\begin{quote}
ay) 16C54 $\rightarrow$ 16C55 $\rightarrow$ 16C56 $\rightarrow$ 16C57
\end{quote}
...
%%-----------
\begin{quote}
bc) ST6200, ST6201, ST6203, ST6208, ST6209,\\
...
%%-----------
\begin{quote}
be) ST9020, ST9030, ST9040, ST9050
\end{quote}
...
%%-----------
\begin{quote}
bj) 320C203 $\rightarrow$ 320C50, 320C51, 320C53
\end{quote}
...
%%-----------
\begin{quote}
bn) 370C010, 370C020, 370C030, 370C040 and 370C050
\end{quote}
...
%%-----------
\begin{quote}
bp) TMS1000, TMS1100, TMS1200, TMS1300
\end{quote}
...
%%-----------
\begin{quote}
bq) IMP-16C/200, IMP-16C/300, IMP-16P/200, IMP-16P/300, IMP-16L
\end{quote}
...
%%-----------
\begin{quote}
bv) COP410 $\rightarrow$ COP420 $\rightarrow$ COP440 $\rightarrow$ COP444
...
\begin{tabbing}
\hspace{0.7cm} \= \kill
bw) \> SC14400, SC14401, SC14402, SC14404, SC14405, \\
...
%%-----------
\begin{quote}
bx) NS16008, NS32008, NS08032, NS16032, NS32016, NS32032, \\
...
\begin{quote}
\begin{tabbing}
ck) \= SYM53C810, SYM53C860, SYM53C815, SYM53C825, \\
    \> SYM53C875, SYM53C895
\end{tabbing}
\end{quote}
...
%%-----------
\begin{quote}
cn) MSM5840, MSM5842, MSM58421, MSM58422, MSM5847
\end{quote}
...
%%-----------
\begin{quote}
cq) PMC150, PMS150, PFS154, PMC131, PMS130, PMS131 \\
...
%%-----------
\begin{quote}
cr) 1802 $\rightarrow$ 1804, 1805, 1806 $\rightarrow$ 1804A,
1805A, 1806A
\end{quote}
