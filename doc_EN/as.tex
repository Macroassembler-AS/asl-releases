...
\vspace{1cm}\par
{\huge Macro Assembler AS V1.42\\ (''ACASM'')}\\
\rule{9.5cm}{0.3mm}\\
\vspace{2mm}\par
{\huge User's Manual}
...
Independent of the target, AS implements multi character constants
in big endian order, which means that 'ABCD' results in an integer
value of 0x41424344.  Why this? Well, AS's first target was the
