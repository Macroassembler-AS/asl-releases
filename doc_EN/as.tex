...
%%-----------
\begin{quote}
an) 80C166 $\rightarrow$ 80C167,80C165,80C163
\end{quote}
...
%%-----------
\begin{quote}
bp) 370C010, 370C020, 370C030, 370C040 and 370C050
\end{quote}
...
%%-----------
\begin{quote}
cu) 1802 $\rightarrow$ 1804, 1805, 1806 $\rightarrow$ 1804A,
1805A, 1806A
\end{quote}
...
AMany 8 bit processors can only process eight bits at once (as the name already
implies...).  They however often contain enough registers to virtuall concatenate
