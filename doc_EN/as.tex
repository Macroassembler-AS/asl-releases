...
used at least once up to this point.  {\bf CAUTION!} The information
of 'being used' is stored along with the symbol in the symbol table.
In case of a forward reference, the symbol does not (yet) exist in the
symbol table in pass one.  Therefore, forward references do not count
as 'usage' in this case.  This situation may be avoided by using a
\tty{FORWARD} declaration of the symbol, thereby making it known
prior to its actual definiton.
