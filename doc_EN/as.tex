...
As an examplr, the Motorola 6800 contains two accumulators named A an B.  It
...
_SARG1    set     substr(_SARG1,1,strlen(_SARG1)-1) ; y->del #
  ...
  endm
\end{verbatim}
Macro arguments hav deliberately been written in all-uppercase.  This way,
