...
the 'original' in its address space's size.  It is not limited
to 2000 bytes, and supports the full 2048 bytes.
%%-----------
\begin{cpulist}
...
\item{\tty{BYTE} resp. \tty{WORD} on PDP-11, VAX and WD16 work like \tty{DB}
      resp. \tty{DW}, however only accept integer arguments.}
\item{\tty{LWORD} resp. \tty{QUAD} on VAXwork like \tty{DD} resp. \tty{DQ},
