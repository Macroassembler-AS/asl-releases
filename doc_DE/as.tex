...
\begin{tabbing}
\hspace{0.7cm} \= \kill
ae) \> 87C750 $\rightarrow$ 8051, 8052, 80C320, 80C501, 80C502, \\
...
%%-----------
\begin{quote}
af) 8096 $\rightarrow$ 80196 $\rightarrow$ 80196N $\rightarrow$ 80296
\end{quote}
...
%%-----------
\begin{quote}
ag) 8080 $\rightarrow$ V30EMU $\rightarrow$ 8085 $\rightarrow$ 8085UNDOC
\end{quote}
...
%%-----------
\begin{quote}
am) AM29245 $\rightarrow$ AM29243 $\rightarrow$ AM29240 $\rightarrow$ AM29000
\end{quote}
...
%%-----------
\begin{quote}
an) 80C166 $\longrightarrow$ 80C167,80C165,80C163
\end{quote}
...
%%-----------
\begin{quote}
ao) LR35902/GBZ80 $\rightarrow$ Z80 $\rightarrow$ Z80UNDOC \\
...
%%-----------
\begin{quote}
as) MICO8\_05, MICO8\_V3, MICO8\_V31
\end{quote}
...
%%-----------
\begin{quote}
ax) 47C00 $\rightarrow$ 470C00 $\rightarrow$ 470AC00
\end{quote}
...
%%-----------
\begin{quote}
ba) 16C54 $\rightarrow$ 16C55 $\rightarrow$ 16C56 $\rightarrow$ 16C57
\end{quote}
...
%%-----------
\begin{quote}
bl) 320C203 $\rightarrow$ 320C50, 320C51, 320C53
\end{quote}
...
%%-----------
\begin{quote}
bx) COP410 $\rightarrow$ COP420 $\rightarrow$ COP440 $\rightarrow$ COP444
\end{quote}
...
\begin{quote}
\begin{tabbing}
cm) \= SYM53C810, SYM53C860, SYM53C815, SYM53C825, \\
    \> SYM53C875, SYM53C895
\end{tabbing}
\end{quote}
...
%%-----------
\begin{quote}
cs) RXV1, RX110, RX111, RX113, RX130, RX210,\\
...
%%-----------
\begin{quote}
ct) PMC150, PMS150, PFS154, PMC131, PMS130, PMS131 \\
...
%%-----------
\begin{quote}
cu) 1802 $\rightarrow$ 1804, 1805, 1806 $\rightarrow$ 1804A, 1805A
1806A
\end{quote}
