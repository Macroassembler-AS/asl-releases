...
CTYPE.INC         & Funktionen zur Klassifizierung von \\
                  & Zeichen \\
EBCDIC.INC        & Definition EBCDIC/Codepage 037 \\
...
{\em G"ultigkeit: PALM, 8008/8080/8085/8086, XA, Z80, Z8000, 320C2x/5x, TLCS-47, AVR, F8}
...
eines einzelnen Zeichens abgefragt werden.
...
%%-----------
\begin{quote}
l) HD6413308 $\longrightarrow$ HD6413309
\end{quote}
...
%%-----------
\begin{quote}
m) HD6475328 $\longrightarrow$ HD6475348 $\longrightarrow$
...
%%-----------
\begin{quote}
n) SH7000 $\longrightarrow$ SH7600 $\longrightarrow$ SH7700
\end{quote}
...
%%-----------
\begin{quote}
q) 6502 $\rightarrow$ 65(S)C02 $\rightarrow$ 65CE02 / W65C02S /
...
%%-----------
\begin{quote}
w) PDP-11/03, PDP-11/04, PDP-11/05, PDP-11/10,
...
\begin{tabbing}
\hspace{0.7cm} \= \kill
ab) \> 87C750 $\rightarrow$ 8051, 8052, 80C320, 80C501, 80C502, \\
...
%%-----------
\begin{quote}
ac) 8096 $\rightarrow$ 80196 $\rightarrow$ 80196N $\rightarrow$ 80296
\end{quote}
...
%%-----------
\begin{quote}
ad) 8080 $\rightarrow$ V30EMU $\rightarrow$ 8085 $\rightarrow$ 8085UNDOC
\end{quote}
...
%%-----------
\begin{quote}
ae) 8086 $\rightarrow$ 80186 $\rightarrow$ V30 $\rightarrow$ V35
\end{quote}
...
%%-----------
\begin{quote}
ai) AT90S1200, AT90S2313, AT90S2323, AT90S233, AT90S2343,\\
...
%%-----------
\begin{quote}
aj) AM29245 $\rightarrow$ AM29243 $\rightarrow$ AM29240 $\rightarrow$ AM29000
\end{quote}
...
%%-----------
\begin{quote}
ak) 80C166 $\longrightarrow$ 80C167,80C165,80C163
\end{quote}
...
%%-----------
\begin{quote}
al) LR35902/GBZ80 $\rightarrow$ Z80 $\rightarrow$ Z80UNDOC \\
...
%%-----------
\begin{quote}
am) Z8601, Z8603, Z86C03, Z86E03, Z86C06, Z86E06, \\
...
%%-----------
\begin{quote}
ap) MICO8\_05, MICO8\_V3, MICO8\_V31
\end{quote}
...
%%-----------
\begin{quote}
au) 47C00 $\rightarrow$ 470C00 $\rightarrow$ 470AC00
\end{quote}
...
%%-----------
\begin{quote}
ax) 16C54 $\rightarrow$ 16C55 $\rightarrow$ 16C56 $\rightarrow$ 16C57
\end{quote}
...
%%-----------
\begin{quote}
bb) ST6200, ST6201, ST6203, ST6208, ST6209,\\
...
%%-----------
\begin{quote}
bd) ST9020, ST9030, ST9040, ST9050
\end{quote}
...
%%-----------
\begin{quote}
bi) 320C203 $\rightarrow$ 320C50, 320C51, 320C53
\end{quote}
...
%%-----------
\begin{quote}
bm) 370C010, 370C020, 370C030, 370C040 und 370C050
\end{quote}
...
%%-----------
\begin{quote}
bo) TMS1000, TMS1100, TMS1200, TMS1300
\end{quote}
...
%%-----------
\begin{quote}
bs) COP410 $\rightarrow$ COP420 $\rightarrow$ COP440 $\rightarrow$ COP444
...
\begin{tabbing}
\hspace{0.7cm} \= \kill
bt) \> SC14400, SC14401, SC14402, SC14404, SC14405, \\
...
%%-----------
\begin{quote}
bu) NS16008, NS32008, NS08032, NS16032, NS32016, NS32032, \\
...
\begin{quote}
\begin{tabbing}
ch) \= SYM53C810, SYM53C860, SYM53C815, SYM53C825, \\
    \> SYM53C875, SYM53C895
\end{tabbing}
\end{quote}
...
%%-----------
\begin{quote}
cn) PMC150, PMS150, PFS154, PMC131, PMS130, PMS131 \\
...
%%-----------
\begin{quote}
co) 1802 $\rightarrow$ 1804, 1805, 1806 $\rightarrow$ 1804A, 1805A
1806A
\end{quote}
...
{\em G"ultigkeit: 680x0, M*Core, 68xx, H8, SH7x00, DSP56xxx,\\
     XA, ST7/STM8, MN161x, IM61x0, CP-3F, PPS-4}
...
\tty{BYTE} bzw. \tty{WORD} stehen auf der PDP-11 als Alias f"ur
\tty{DB} bzw. \tty{DW} zur Verf"ugung, sowie \tty{FLT2} und \tty{FLT4},
die im Gegensatz zu \tty{DD} bzw. \tty{DQ} aber nur Gleitkommazahlen
im Speicher ablegen (im DEC-eigenen F- bzw. D-Format).
