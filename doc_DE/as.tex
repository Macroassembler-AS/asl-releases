...
\item{National Semiconductor CR16A/B}
...
\item{\tty{intsyntax}: Mit diesem Schalter kann man vom Beginn des Programms
      ...
      (siehe Abschnitt \ref{SectINTSYNTAX} f"ur eine Liste erlauber
      Argumente).}
...
Paul, Norbert Rosch, Curt J.  Sampson, Steffen Schmid, Leonhard
Schneider, Ernst Schwab, Michael Schwingen, Oliver Sellke,
