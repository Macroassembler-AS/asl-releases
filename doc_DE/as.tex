...
\begin{tabbing}
\hspace{0.7cm} \= \kill
aa) \> 87C750 $\rightarrow$ 8051, 8052, 80C320, 80C501, 80C502, \\
...
%%-----------
\begin{quote}
ab) 8096 $\rightarrow$ 80196 $\rightarrow$ 80196N $\rightarrow$ 80296
\end{quote}
...
%%-----------
\begin{quote}
ac) 8080 $\rightarrow$ V30EMU $\rightarrow$ 8085 $\rightarrow$ 8085UNDOC
\end{quote}
...
%%-----------
\begin{quote}
ad) 8086 $\rightarrow$ 80186 $\rightarrow$ V30 $\rightarrow$ V35
\end{quote}
...
%%-----------
\begin{quote}
ah) AT90S1200, AT90S2313, AT90S2323, AT90S233, AT90S2343,\\
...
%%-----------
\begin{quote}
ai) AM29245 $\rightarrow$ AM29243 $\rightarrow$ AM29240 $\rightarrow$ AM29000
\end{quote}
...
%%-----------
\begin{quote}
aj) 80C166 $\longrightarrow$ 80C167,80C165,80C163
\end{quote}
...
%%-----------
\begin{quote}
ak) LR35902/GBZ80 $\rightarrow$ Z80 $\rightarrow$ Z80UNDOC \\
...
%%-----------
\begin{quote}
al) Z8601, Z8603, Z86C03, Z86E03, Z86C06, Z86E06, \\
...
%%-----------
\begin{quote}
ao) MICO8\_05, MICO8\_V3, MICO8\_V31
\end{quote}
...
%%-----------
\begin{quote}
at) 47C00 $\rightarrow$ 470C00 $\rightarrow$ 470AC00
\end{quote}
...
%%-----------
\begin{quote}
aw) 16C54 $\rightarrow$ 16C55 $\rightarrow$ 16C56 $\rightarrow$ 16C57
\end{quote}
...
%%-----------
\begin{quote}
ba) ST6200, ST6201, ST6203, ST6208, ST6209,\\
...
%%-----------
\begin{quote}
bc) ST9020, ST9030, ST9040, ST9050
\end{quote}
...
%%-----------
\begin{quote}
bh) 320C203 $\rightarrow$ 320C50, 320C51, 320C53
\end{quote}
...
%%-----------
\begin{quote}
bl) 370C010, 370C020, 370C030, 370C040 und 370C050
\end{quote}
...
%%-----------
\begin{quote}
bn) TMS1000, TMS1100, TMS1200, TMS1300
\end{quote}
...
%%-----------
\begin{quote}
br) COP410 $\rightarrow$ COP420 $\rightarrow$ COP440 $\rightarrow$ COP444
...
\begin{tabbing}
\hspace{0.7cm} \= \kill
bs) \> SC14400, SC14401, SC14402, SC14404, SC14405, \\
...
%%-----------
\begin{quote}
bt) NS16008, NS32008, NS08032, NS16032, NS32016, NS32032, \\
...
\begin{quote}
\begin{tabbing}
cg) \= SYM53C810, SYM53C860, SYM53C815, SYM53C825, \\
    \> SYM53C875, SYM53C895
\end{tabbing}
\end{quote}
...
%%-----------
\begin{quote}
cm) PMC150, PMS150, PFS154, PMC131, PMS130, PMS131 \\
...
%%-----------
\begin{quote}
cn) 1802 $\rightarrow$ 1804, 1805, 1806 $\rightarrow$ 1804A, 1805A
1806A
\end{quote}
