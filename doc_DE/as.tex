...
definiert ist, oder ein Formelausdruck keine bisher undefinierten Symbole
enth"alt, l"a"st sich auch einfach mit der \tty{DEFINED}-Funktion abfragen.
\begin{table}[htb]
\begin{center}
\begin{tabular}{|l|c|}
\hline
...
\begin{itemize}
\item{\tty{IFDEF} $<$Ausdruck$>$ : wahr, falls das der Ausdruck keine Symbole
      enth"alt, die bisher undefiniert sind.}
