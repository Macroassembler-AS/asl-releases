...
bisher schon einmal verwendet wurde.  {\bf ACHTUNG:} Da diese Information
am Symbol in der Symboltabelle nachgehalten wird, und da ein Symbol bei
einer Vorw"artsreferenz im ersten Pass noch nicht in der Symboltabelle
existiert, wird eine Vorw"artsreferenz in so einem Fall nicht als
Benutzung gerechnet!  Diese Situation kann durch Verwendung des
\tty{FORWARD}-Befehls vermieden werden.
