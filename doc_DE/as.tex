...
{\em
\begin{itemize}
\item{G"ultigkeit: VAX}
\end{itemize}
}

Die VAX kennt nicht nur einen Supervisor- un User-Mode, sonder vier derartige
Privilegstufen.  Mit absteigenden Rechten heissen diese Zugriffs-Modi Kernel,
Executive, Supervisor und User.  Mit dem {\tt ACCMODE}-Befehl teilt man dem
