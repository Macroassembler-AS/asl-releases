...
\item{\label{radix}\tty{RADIX}: Stellt das Default-Zahlensystem auf
      ...
      durch die gleichnamige Anweisung im Programm übersteuert werden.}
...
im durch den List-Radix gegebenen Zahlensystem.  Je nach Prozessortyp und aktuellem Segment
...
nämlich eine in eckigen Klammern davor geschriebene Zahl von
Wiederholungen.
\par
...
Genauigkeit und Wertebereich haben können als das auf dem Host-System verwendete
