...
%%\begin{itemize}
%%\item{,,AC'' k"onnte einfach für meine Heimatstadt Aachen stehen, denn dies
...
ob der Wert mit f"uhrenden Nullen angezeigt werden soll oder nicht.
\par
...
benutzt man stattdessen \tty{PAGESIZE}.  Alternativ ist es immer möglich,
...
direkt mit \asname{} zu tun, immerhin ist er aber mein Chef und wirft
...
\asname{} nicht zu machen.  Ich habe von einer enormen Anzahl von Leuten
...
\par
So ganz allein habe ich \asname{} nicht verzapft.  Die DOS-Version von \asname{} enthielt
