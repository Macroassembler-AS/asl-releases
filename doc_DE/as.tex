...
kan diese Schreibweise aber für existierenden Code erlauben, weil einige "altere
...
%%-----------
\begin{quote}
bp) IMP-16C/200, IMP-16C/300, IMP-16P/200, IMP-16P/300, IMP-16L
\end{quote}
...
%%-----------
\begin{quote}
bu) COP410 $\rightarrow$ COP420 $\rightarrow$ COP440 $\rightarrow$ COP444
...
\begin{tabbing}
\hspace{0.7cm} \= \kill
bv) \> SC14400, SC14401, SC14402, SC14404, SC14405, \\
...
%%-----------
\begin{quote}
bw) NS16008, NS32008, NS08032, NS16032, NS32016, NS32032, \\
...
\begin{quote}
\begin{tabbing}
cj) \= SYM53C810, SYM53C860, SYM53C815, SYM53C825, \\
    \> SYM53C875, SYM53C895
\end{tabbing}
\end{quote}
...
%%-----------
\begin{quote}
cp) PMC150, PMS150, PFS154, PMC131, PMS130, PMS131 \\
...
%%-----------
\begin{quote}
cq) 1802 $\rightarrow$ 1804, 1805, 1806 $\rightarrow$ 1804A, 1805A
1806A
\end{quote}
...
\ttindex{BIGENDIAN}\label{SectBIGENDIAN}
